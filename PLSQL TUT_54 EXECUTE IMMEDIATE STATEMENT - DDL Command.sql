---------------EXECUTE DDL COMMAND WITH - EXECUTE IMMEDIATE STATEMENT (CREATE) [WAY 1]-----------------
...
-------------------EXECUTE DDL COMMAND WITH - EXECUTE IMMEDIATE STATEMENT(ALTER)----------------
...
BEGIN
    DDL_QRY := 'ALTER TABLE TUT83 ADD TUT_DATE DATE';
...
---------------------------EXECUTE DDL COMMAND WITH - EXECUTE IMMEDIATE STATEMENT(DROP)---------------
